...
@WebServiceClient(name = "AtendeClienteService", targetNamespace = "http://cliente.bean.master.sigep.bsb.correios.com.br/", wsdlLocation = "file:/C:/Projetos/workspace-consultacep/src/main/resources/correios.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Projetos/workspace-consultacep/src/main/resources/correios.wsdl");
